...
export const adminSections: AdminSection[] = [
  ...
  },
  {
    ...
    description: "Gere QR Codes para materiais impressos",
    href: "/admin/marketing/qrcode",
    icon: QrCode,
    iconBgColor: "bg-blue-500",
    keywords: ["qr", "qrcode", "cardapio", "delivery", "impressao", "material"],
    group: "Marketing",
  },
  {
    id: "marketing-pdf-catalog",
    title: "Cardapio em PDF",
    description: "Exporte seu catalogo completo como PDF",
    href: "/admin/marketing/pdf-catalog",
    icon: FileText,
    iconBgColor: "bg-purple-500",
    keywords: ["pdf", "cardapio", "catalogo", "imprimir", "exportar"],
    group: "Marketing",
  },
  {
    ...
    keywords: ["avaliacao", "review", "estrela", "nota", "feedback", "cliente"],
    group: "Marketing",
  },
  {
    id: "mesas",
  ...
  },
  {
    ...
    keywords: ["nfe", "nota fiscal", "fiscal", "nfio", "imposto", "danfe", "sefaz"],
    group: "Configurações",
  },
  {
    id: "notas-fiscais",
    title: "Histórico de NF-e",
    description: "Visualize e gerencie as notas fiscais emitidas",
