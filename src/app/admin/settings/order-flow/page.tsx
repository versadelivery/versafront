...
import { ArrowLeft, GripVertical, Check, X, ListOrdered, RotateCcw, Zap, AlertCircle } from "lucide-react";
...
export default function OrderFlowSettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F7]">
      ...
      {/* Conteudo */}
      <div className="max-w-[800px] mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-5">
        {/* Presets */}
              ...
              {flow.map((status, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isFixed ? (
                      <span className="text-[10px] font-medium text-muted-foreground bg-gray-100 px-2 py-0.5 rounded">
                        Obrigatório
                      </span>
                    ) : hasActiveOrders(status) ? (
                      <span className="flex items-center gap-1 text-[10px] font-medium text-orange-600 bg-orange-50 px-2 py-0.5 rounded border border-orange-200"
