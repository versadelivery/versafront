    ...
    >
      <div className="w-full px-6 sm:px-10 lg:px-14 flex items-center h-[96px]">
        <Link href="/" className="flex-shrink-0 mr-12">
          <Image src={logo} alt="Versa Delivery" width={220} height={64} />
        </Link>
        ...
        <div className="hidden md:flex items-center gap-10">
          {navLinks.map((link) => (
            <button
              ...
              className="font-tomato text-black hover:text-[#009246] text-md font-bold transition-colors cursor-pointer"
            >
              {link.name}
            </button>
          ))}
        ...
        <div className="hidden md:flex items-center gap-3 ml-auto">
          <Link href="/login">
            <button className="text-[#1B1B1B] text-[15px] font-semibold px-3 py-1.5 hover:opacity-70 transition-opacity cursor-pointer">
              Conectar-se
            </button>
          </Link>
          <Link href="/login">
            <button className="bg-[#1B1B1B] hover:bg-black text-white text-[15px] font-semibold px-6 py-2.5 rounded-xl transition-colors cursor-pointer">
              Comece agora
            </button>
          </Link>
        </div>
          ...
          >
            <div className="px-6 py-4 space-y-1">
              ...
              <div className="pt-4 space-y-2 border-t border-[#E8E4DF]">
                ...
                <Link href="/login" onClick={closeMenu} className="block">
                  <button className="w-full bg-[#1B1B1B] text-white text-base font-semibold py-3 rounded-xl transition-colors cursor-pointer">
                    Comece agora
                  </button>
                </Link>
              </div>
