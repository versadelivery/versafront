...
import { ItemExtras } from "./item-extras"
import { ItemPrepareMethods } from "./item-prepare-methods"
import { PriceInput } from "@/app/components/ui/price-input"
...
export function NewItemModal({ isOpen, onOpenChange }: NewItemModalProps) {
  ...
  const handlePrepareMethodChange = (index: number, field: keyof { name: string }, value: string) => {
